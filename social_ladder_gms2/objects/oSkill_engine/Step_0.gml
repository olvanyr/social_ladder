...
if global.experience >= xp_wall_jump && global.wall_jump == false && !showcase
{
	new_ability = true;
	ability = "wall_jump";
	exit;
...
if global.experience >= xp_double_jump && global.double_jump == false && !showcase
{
	new_ability = true;
	ability = "double_jump";
	exit;
...
if global.experience >= xp_cast && global.cast == false && !showcase
{
	new_ability = true;
	ability = "cast";
	exit;
